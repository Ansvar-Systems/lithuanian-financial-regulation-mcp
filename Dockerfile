# Lithuanian Financial Regulation MCP — multi-stage Dockerfile
# Build:  docker build -t lithuanian-financial-regulation-mcp .
# Run:    docker run --rm -p 3000:3000 lithuanian-financial-regulation-mcp
#
# The image expects a pre-built database at /app/data/lb.db.
# Override with LB_DB_PATH for a custom location.
...
COPY data/database.db data/lb.db
