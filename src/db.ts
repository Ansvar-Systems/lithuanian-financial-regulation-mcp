/**
 * SQLite database access layer for the Lietuvos bankas financial regulation MCP server.
 *
 * Schema mirrors the Lietuvos bankas (Bank of Lithuania) regulatory structure:
 *   - sourcebooks        — top-level LB regulatory sourcebook collections
 *   - provisions         — individual LB nutarimai, gairės, and rekomendacijos
 *   - enforcement_actions — LB enforcement decisions and sanctions
 *
